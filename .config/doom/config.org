...
Pulsing is possible by adding this to packages.el.

#+begin_src elisp
;; (package! pulsing-cursor :recipe (:host github :repo "jasonjckn/pulsing-cursor"))
#+end_src

Then uncommenting this here.
...
This is actually done by Doom, so this may be causing more issues than solving. See: https://github.com/purcell/exec-path-from-shell/issues/112.
