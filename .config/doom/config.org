...
#+begin_src elisp
(setq
  doom-font (font-spec :family "ZedMono NF Light" :size 20)
  doom-big-font (font-spec :family "ZedMono NF Light" :size 24)
  doom-variable-pitch-font (font-spec :family "ZedMono NF Light" :size 20))
