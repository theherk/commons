;;; h4s-tokyo-night-theme.el --- inspired by VSCode's Tokyo Night theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
;;
;;; Commentary: Altered by Adam Sherwood from source at https://raw.githubusercontent.com/doomemacs/themes/master/themes/h4s-tokyo-night-theme.el
;;; Code:
...
(defgroup h4s-tokyo-night-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom h4s-tokyo-night-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'h4s-tokyo-night-theme
  :type 'boolean)

(defcustom h4s-tokyo-night-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'h4s-tokyo-night-theme
  :type 'boolean)

(defcustom h4s-tokyo-night-comment-bg h4s-tokyo-night-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their legibility."
  :group 'h4s-tokyo-night-theme
  :type 'boolean)

(defcustom h4s-tokyo-night-padded-modeline nil
...
(def-doom-theme h4s-tokyo-night
  ...
  ((bg         '("#1a1b26" nil       nil            ))
   ...
   (selection      base0)
   (builtin        red)
   (comments       (if h4s-tokyo-night-brighter-comments base5 base1))
   (doc-comments   (doom-lighten (if h4s-tokyo-night-brighter-comments base5 base1) 0.25))
   (constants      orange)
   (functions      blue)
   (keywords       magenta)
   (methods        blue)
   ...
   (-modeline-bright h4s-tokyo-night-brighter-modeline)
   (-modeline-pad
    (when h4s-tokyo-night-padded-modeline
      (if (integerp h4s-tokyo-night-padded-modeline) h4s-tokyo-night-padded-modeline 4)))
  ...
  (
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if h4s-tokyo-night-comment-bg (doom-lighten bg 0.05)))
   (font-lock-doc-face
...
;;; h4s-tokyo-night-theme.el ends here
