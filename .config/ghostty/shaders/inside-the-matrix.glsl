                    ...
                    if (v >= 0.0 && v < 1.0) {
                        ...
                        if (char_hash.x >= 0.1 || c == 0.) {  //10% of missed symbols
                            ...
                            if (a > 0.) {
                                ...
                                vec3 col = (c == 0. ? vec3(0.55, 0.65, 0.58) : vec3(0.35, 0.55, 0.40)) / attenuation;
                                float a1 = result.a;
                                result.a = a1 + (1. - a1) * a;
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    vec3 col = rain(ro, rd, time) * 0.475;
    ...
    vec3 blendedColor = mix(terminalColor.rgb * 1.2, col, mask * 0.666);
