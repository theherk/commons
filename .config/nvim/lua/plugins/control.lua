return {
  ...
  },
  {
    ...
    keys = {
      { "<leader>f1", function() require("harpoon.ui").nav_file(1) end, mode = { "i", "n" }, desc = "harpoon file 1" },
      { "<leader>f2", function() require("harpoon.ui").nav_file(2) end, mode = { "i", "n" }, desc = "harpoon file 2" },
      { "<leader>f3", function() require("harpoon.ui").nav_file(3) end, mode = { "i", "n" }, desc = "harpoon file 3" },
      { "<leader>f4", function() require("harpoon.ui").nav_file(4) end, mode = { "i", "n" }, desc = "harpoon file 4" },
      { "<leader>f5", function() require("harpoon.ui").nav_file(5) end, mode = { "i", "n" }, desc = "harpoon file 5" },
      { "<leader>f6", function() require("harpoon.ui").nav_file(6) end, mode = { "i", "n" }, desc = "harpoon file 6" },
      { "<leader>f7", function() require("harpoon.ui").nav_file(7) end, mode = { "i", "n" }, desc = "harpoon file 7" },
      { "<leader>f8", function() require("harpoon.ui").nav_file(8) end, mode = { "i", "n" }, desc = "harpoon file 8" },
      { "<leader>f9", function() require("harpoon.ui").nav_file(9) end, mode = { "i", "n" }, desc = "harpoon file 9" },
      { "<leader>fl", function() require("harpoon.ui").toggle_quick_menu() end, mode = { "i", "n" }, desc = "harpoon list" },
