...
vim.keymap.set("v", "<localleader>t", ":!pandoc -f markdown-simple_tables+pipe_tables -t markdown-grid_tables-multiline_tables-simple_tables+pipe_tables<cr>", { desc = "fmt table" })
