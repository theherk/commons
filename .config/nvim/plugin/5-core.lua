...
later(function()
  ...
  vim.keymap.set("n", "<leader>cs", "<cmp>Pick lsp scope='document_symbol'<cr>", { desc = "document symbols" })
  vim.keymap.set("n", "<leader>cS", "<cmp>Pick lsp scope='workspace_symbol'<cr>", { desc = "workspace symbols" })
